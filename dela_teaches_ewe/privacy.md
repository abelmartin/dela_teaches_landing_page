...
.app-privacy-wrapper p {
  margin-bottom: 1.25rem;
}

.app-privacy-wrapper ul,
.app-privacy-wrapper ol {
  padding-left: 1.75rem;
  margin: 1rem 0 1.5rem;
}

.app-privacy-wrapper li {
  margin-bottom: 0.65rem;
  line-height: 1.75;
}

.app-privacy-wrapper a {
  color: var(--primary-color);
  text-decoration: underline;
  transition: var(--transition);
}

.app-privacy-wrapper a:hover {
...
.app-privacy-table tr:nth-child(even) {
...
.app-toc-grid a:hover {
  color: var(--primary-color);
  text-decoration: underline;
}

.privacy-switch-notice {
  display: flex;
  align-items: center;
...
<div class="app-privacy-wrapper">
  ...
  <p>This policy details what information the App collects, how that information is handled, how we utilize third-party services such as <strong>Google LLC</strong> for advertising and analytics tracking, and your choices under Apple's <strong>App Tracking Transparency (ATT)</strong> framework, the General Data Protection Regulation (GDPR), the California Consumer Privacy Act (CCPA/CPRA), and the Children's Online Privacy Protection Act (COPPA).</p>

  <div class="app-toc-box">
    <div class="app-toc-title">
  ...
  <h2 id="summary">1. Summary of Data Practices</h2>
  <p>The table below provides an at-a-glance summary of our data collection, tracking, and sharing practices in compliance with Apple App Store specifications:</p>

  <table class="app-privacy-table">
    <thead>
      <tr>
        <th>Data Category</th>
    ...
    <tbody>
      <tr>
        <td><strong>Personal Contact Info</strong> (Name, Email, Phone, Address)</td>
      ...
      <tr>
        <td><strong>Audio / Microphone Recordings</strong></td>
        <td><strong>No</strong></td>
        <td><strong>No</strong></td>
      ...
      <tr>
        <td><strong>Approximate Location</strong> (Country / Region level)</td>
        <td><strong>Coarse only</strong> (via IP)</td>
        <td><strong>Yes</strong> (Google LLC)</td>
        <td>Derived by third-party ad/analytics networks to serve regional ads and analyze aggregate trends. No precise GPS is collected.</td>
      </tr>
    </tbody>
  </table>

  <h2 id="direct-collection">2. Information We Do Not Collect Directly</h2>
  <p>Dela Teaches LLC believes in minimal data collection. When you install and use <strong>Dela Teaches Ewe</strong>:</p>
  <ul>
    <li><strong>No Account Required:</strong> You do not need to create an account, log in, or provide your name, email address, physical address, or phone number.</li>
    <li><strong>Local Progress Storage:</strong> Your learning progress—including completed vocabulary lists, quiz scores, spelling results, and selected preferences—is saved entirely on your local device using on-device storage. If you uninstall the App or clear your device application cache, your local learning history is removed.</li>
  ...
  <p>The App displays banner and interstitial advertisements via the <strong>Google Mobile Ads SDK</strong>. When an ad request is initiated, Google may automatically collect and process certain device and diagnostic information, including:</p>
  <ul>
    <li>Device information (such as hardware model, operating system version, screen size, and device orientation).</li>
    <li>Internet Protocol (IP) address, which may indicate your general geographic location (e.g., country or metropolitan area).</li>
    <li>Mobile advertising identifiers (Apple IDFA on iOS or Google Advertising ID on Android), subject to your tracking choices and consent.</li>
    <li>Interaction data, such as ad impressions, clicks, and viewability metrics.</li>
  </ul>
  ...
  <ul>
    ...
    <li>User taps, navigation events, and feature interactions (such as taps on vocabulary categories, flashcard flips, quiz responses, spelling exercises, and audio playback controls).</li>
    <li>Category engagement (e.g., which vocabulary groups or quizzes are accessed most frequently).</li>
    <li>Diagnostic data, performance metrics, and application crash reports.</li>
  </ul>
  <p>This information is processed in pseudonymized and aggregated formats to optimize application stability, usability, and educational effectiveness.</p>
  ...
  <p>According to Apple's App Store Review Guidelines, "tracking" refers to the act of linking user or device data collected from our App with user or device data collected from other companies' apps, websites, or offline properties for targeted advertising or advertising measurement purposes, or sharing user or device data with data brokers.</p>

  <h3>Your Choices Under the ATT Prompt</h3>
  <p>When you open Dela Teaches Ewe on iOS, you may be presented with an Apple App Tracking Transparency dialog asking: <em>"Allow 'Dela Teaches Ewe' to track your activity across other companies' apps and websites?"</em></p>
  <ul>
    <li><strong>If you tap "Allow":</strong> Google AdMob and Google Analytics may access your device's IDFA to provide personalized advertisements tailored to your interests and measure the performance of advertising campaigns.</li>
    <li><strong>If you tap "Ask App not to Track":</strong> The App will strictly respect your decision. The IDFA will be zeroed out, no cross-app tracking will occur, and only non-personalized, contextual advertisements will be requested.</li>
  </ul>

  <h3>How to View or Change Your Tracking Choice at Any Time</h3>
  ...
  <h2 id="third-party-protection">5. Third-Party Data Protections (Apple Guideline 5.1.1)</h2>
  ...
  <ul>
    ...
    <li>Because the App requires no account creation, no names, email addresses, phone numbers, or photos are ever collected from any user, including children.</li>
